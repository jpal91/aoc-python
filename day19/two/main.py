...
if __name__ == '__main__':
    ...
    # for combo in combinations(range(1, 4001), 4):
    #     wf = WorkFlow(*combo)
    #     if rule_set.eval_wf(wf):
    #         print(wf)
    #         break

    # for combo in combinations(range(4000, 0, -1), 4):
    #     wf = WorkFlow(*combo)
    #     if rule_set.eval_wf(wf):
    #         print(wf)
    #         break

    # wf = WorkFlow(3999, 3997, 2733, 2522)
    # print(rule_set.eval_wf(wf))
    print(len(list(combinations_with_replacement([*range(1, 4001), *range(2, 4000), *range(3, 3999), *range(4, 3998)], 4))))

# WorkFlow(x=1, m=2, a=3, s=4)
# WorkFlow(x=4000, m=3999, a=2744, s=2743)
